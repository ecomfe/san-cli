/**
 * @file webpack bundle analyzer
 * Inspired by
 * https://github.com/webpack-contrib/webpack-bundle-analyzer/blob/ba3dbd71cec7becec0fbf529833204425f66efde/src/parseUtils.js
 * https://github.com/vuejs/vue-cli/blob/dev/packages/%40vue/cli-service/lib/webpack/analyzeBundle.js
 */
...
exports.analyzeBundle = function analyzeBundle(bundleStats, assetSources) {
    ...
    for (const asset of jsAssets) {
        ...
        if (!bundleInfo) {
            warn(
                `
Couldn't parse bundle asset "${asset.fullPath}". Analyzer will use module sizes from stats file.
    `
            );
            parsedModules = null;
            bundlesSources = null;
