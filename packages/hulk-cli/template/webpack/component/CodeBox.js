...
export default function getCodeBoxComponentClass(withPreview = true) {
    return class CodeBox extends Component {
        static template = /*html*/ `
        <section class="code-box {{isExpand?'expand':''}}" id="{{id}}">
            ${withPreview ? '<section class="code-box-demo"><code-preview/></section>' : ''}
