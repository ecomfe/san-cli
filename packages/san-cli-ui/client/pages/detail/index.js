        ...
        <div class="detail">
            ...
            <c-layout menu="{{menuData}}" nav="{=nav=}" title="{=headTitle=}">
                <template slot="right">
                    ...
                    <div s-elif="route.query.func === 'plugin'">
                        plugins head
                    </div>
                    <div s-elif="route.query.func === 'dependency'">
                        dependencies head
                    </div>
                ...
                <div slot="content">
                    ...
                    <c-plugin s-elif="route.query.func === 'plugin'"></c-plugin>
                    <c-dependency s-elif="route.query.func === 'dependency'"></c-dependency>
