...
<img src="./assets/dashboard.png" style="width: 80%; max-width: 1000px;" />

- **运行任务**部件：在运行任务部件中，配置一个任务，比如 start 任务，就可以快捷地运行start任务了。“运行任务”部件支持配置多个，也即可以配置多个不同任务同时运行。

<img src="./assets/run-task-widget.png" style="width: 80%; max-width: 1000px;" />
...
<img src="./assets/news-widget.png" style="width: 80%; max-width: 1000px;" />
### 自定义仪表盘
...
<img src="./assets/custom-dashboard.png" style="width: 80%; max-width: 1000px;" />
